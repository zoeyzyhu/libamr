    ...
    def allocate(self, nvar: int = 1) -> Self:
        ...
        for o3 in [-1, 0, 1]:
            for o2 in [-1, 0, 1]:
                for o1 in [-1, 0, 1]: 
                    ...
                    if o1 == -1: offset1, len1 = nghost, nghost
                    if o1 == 0: offset1, len1 = nghost, self.nx1
                    if o1 == 1: offset1, len1 = self.nx1, nghost
                    ...
                    if o2 == -1: offset2, len2 = nghost, nghost
                    if o2 == 0: offset2, len2 = nghost, self.nx2
                    if o2 == 1: offset2, len2 = self.nx2, nghost
                    ...
                    if o3 == -1: offset3, len3 = nghost, nghost
                    if o3 == 0: offset3, len3 = nghost, self.nx3
                    if o3 == 1: offset3, len3 = self.nx3, nghost
        ...
        for o3 in [-1, 0, 1]:
            for o2 in [-1, 0, 1]:
                for o1 in [-1, 0, 1]: 
                    nghost = self.coord.nghost
                    if o1 == -1: offset1, len1 = 0, nghost
                    if o1 == 0: offset1, len1 = nghost, self.nx1
                    if o1 == 1: offset1, len1 = nghost + self.nx1, nghost
                    ...
                    if o2 == -1: offset2, len2 = 0, nghost
                    if o2 == 0: offset2, len2 = nghost, self.nx2
                    if o2 == 1: offset2, len2 = nghost + self.nx2, nghost
                    ...
                    if o3 == -1: offset3, len3 = 0, nghost
                    if o3 == 0: offset3, len3 = nghost, self.nx3
                    if o3 == 1: offset3, len3 = nghost + self.nx3, nghost
                    ...
                    self.ghost[(o3, o2, o1)] = as_strided(
                        self.data[offset3: offset3 + len3,
                                  ...
                                  0: self.nvar],
                        shape = (len3, len2, len1, self.nvar),
                        strides = (self.nc2 * self.nc1 * self.nvar * byte, self.nc1 * self.nvar * byte, self.nvar * byte, byte)
                    )
        return self
